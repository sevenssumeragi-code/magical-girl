...
| [`docs/WALKTHROUGH.md`](docs/WALKTHROUGH.md) | 全8エンディングの攻略手順（ネタバレ） |
...
- [x] **フェーズ3: 本文執筆** — 全80シーン / 60,611字 / 台詞1,068行
- [x] **フェーズ4: 統合** — 全8エンディングの到達性を通し再生で検証、攻略手順を作成
- [x] **フェーズ5: 品質保証** — テスト94件・lint 2種とも違反0

**シナリオは完成しています。** 残るのはグラフィックとBGMの差し替えのみで、
`assets/ASSET_MANIFEST.json` の128点を本物に置き換えれば製品版になります。
